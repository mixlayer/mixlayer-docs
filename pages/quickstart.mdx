...
<Callout type="info" emoji="ℹ️">
  We require a credit card number to sign up for an account, even on our Free account. However, we provide a starter model free of charge. On our Free plan you will not be charged for usage unless you make requests to the paid models in the playground or in an app. 
</Callout>
...
* Specifying a `system` prompt at the beginning to customize the output and personality of the output to your liking
