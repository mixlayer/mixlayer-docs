...
Building in this way means that models are more programmable and easier to use. Many complex use-cases such as multi-step prompting, tool use and structured output fall out naturally as a result of this design. 

Most AI inference APIs have amnesia. When you send them requests, you have to remind them of everything you've told them before. Mixlayer is stateful: while your code is executing you have total control over the model's context. You don't have to send new requests for every message in a conversation between your code and the model, or every step of a multi-step process.
