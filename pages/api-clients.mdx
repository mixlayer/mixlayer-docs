---
title: API Clients
description: OpenAI-compatible API clients for Mixlayer
---

# API Clients 

Mixlayer provides an OpenAI-compatible Chat Completions API for interacting with our models. The API is available at `https://models.mixlayer.ai/v1/chat/completions`. The API has full support for streaming and tool calling. 

To use the REST API, you need to provide an API key. You can create an API key in the [Mixlayer console](https://console.mixlayer.com/app/api-keys).
